...
//    using FiscalModel;
//
//    var FiscalDTO = FiscalDTO.FromJson(jsonString);
#nullable enable
...
namespace FiscalModel
{
    ...
    public partial class FiscalDTO
    {
    ...
    public partial class FiscalDTO
    {
        public static FiscalDTO FromJson(string json) => JsonSerializer.Deserialize<FiscalDTO>(json, Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this FiscalDTO self) => JsonSerializer.Serialize(self, Converter.Settings);
    }
